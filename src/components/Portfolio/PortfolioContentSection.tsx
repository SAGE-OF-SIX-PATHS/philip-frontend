...
const PortfolioContentSection: React.FC<ContentSectionProps> = ({
  ...
  return (
    ...
    >
      ...
      <h3
        className={`text-xl sm:text-2xl font-bold mb-2 transition-colors text-center sm:text-left ${
          isDarkMode
      ...
      <div className="flex flex-col sm:flex-row items-center sm:items-center mb-3 text-center sm:text-left">
        ...
        <ExternalLink
          className={`ml-0 sm:ml-2 mt-1 sm:mt-0 transition-colors ${
            isDarkMode
      ...
      <p
        className={`leading-relaxed mb-5 text-sm sm:text-base transition-colors text-center sm:text-left ${
          isDarkMode
